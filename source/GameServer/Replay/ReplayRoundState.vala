...
namespace GameServer
{
    ...
    public class ReplayRoundState : Object
    {
        ...
        private void restore_initial_hands()
        {
            ...
            if (has_saved_hands)
            {
                Environment.log(LogType.DEBUG, "ReplayRoundState", "Using saved initial hands from new log format");
            ...
            else
            {
                ...
                Environment.log(LogType.INFO, "ReplayRoundState", "Old log format detected - simulating initial dealing");
        ...
        private void play_action(ServerAction action)
        {
            ...
            {
                handle_client_action(action as ClientServerAction);
            }
        }
        ...
        {
            // TODO: Get scoring info from somewhere
            Environment.log(LogType.DEBUG, "ReplayRoundState", "Ron not fully implemented");
        }

        private void handle_tsumo(int player)
        {
            // TODO: Get scoring info from somewhere
            Environment.log(LogType.DEBUG, "ReplayRoundState", "Tsumo not fully implemented");
        }
